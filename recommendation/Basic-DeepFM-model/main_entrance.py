...
'''flags: 判定进入训练模式/预测模式，指定源模型路径，'''
flags.DEFINE_integer("save_DeepFM_checkpoints_steps", 1000,
                     "How often to save the DeepFM model checkpoint.")
flags.DEFINE_bool("do_train", True, "Whether to run training.")

flags.DEFINE_bool("do_predict", False, "Whether to run eval on the dev set. Predict with loaded model")
flags.DEFINE_string(
    "init_DeepFM_checkpoint", None,
    "Initial DeepFM checkpoint (usually from a pre-trained BERT model).")
...
if flags.do_predict:
	...
	# ------------------ Load DeepFM Model From Checkpoint -----------------------
	if init_checkpoint:
